...
var s_name = '';
var s_pwd = '';
var s_stream_type = 'live';
var output_format = '';
var global_responseData;

(function(plugin) {
    var PLUGIN_PREFIX = "xtream_live:";
    var responseData;
    var cfg_data = JSON.parse(fs.readFileSync("/home/gx/plugincfg/xtream_live.cfg"));
    ...
    print(s_url);
    var service = plugin.createService("xtream_live", PLUGIN_PREFIX+"start", "video", true, plugin.path + "xtream_live.png");
